...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#faf9f6] text-[#25221f]">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 md:px-8 lg:grid-cols-[1fr_420px]">
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative space-y-4 rounded-lg border border-[#e7e0d6] bg-white p-5 shadow-sm">
              <div className="flex items-start justify-between"><div><h2 className="text-base font-black tracking-tight">Ward budget - Lalitpur</h2><p className="mt-1 text-xs text-[#68615b]">Ward 7 · Lalitpur Metropolitan City</p></div><span className="rounded-full bg-[#eef6f4] px-2.5 py-1 text-[10px] font-black uppercase text-[#0f3d3e]">Ongoing</span></div>
      ...
      <footer className="bg-[#23344f] text-white"><div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-10 md:flex-row md:items-center md:justify-between md:px-8"><CivicLogo light /><p className="text-sm font-semibold text-white/80">Making reports, budgets, and public work accountable in every ward.</p></div></footer>
    </main>
  );
}